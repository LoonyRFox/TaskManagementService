...
{
    var url = "http://localhost:5250"; // укажи здесь свой адрес приложени€, если другой
    var swaggerUrl = $"{url}";

    // «апускаем браузер с Swagger UI
    try
    {
    ...
    {
        // »гнорируем ошибки, если не удалось запустить браузер
    }
}
